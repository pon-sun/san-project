...
class HitcaseApiService {
    ...
    CreateHitcase = async (payload: HitcasePayload) => {
        try {
            const response = await this.httpClientWrapper.ALpost3('/api/hitcase/CreateHitcase', payload);
    ...
    CreateHitCaseInsert = async (payload: HitcasePayload) => {
        try {
            const response = await this.httpClientWrapper.ALpost3('/api/insert/CreateHitCase', payload);
            const data = response.data;
            return data;
        } catch (error) {
            throw error;
