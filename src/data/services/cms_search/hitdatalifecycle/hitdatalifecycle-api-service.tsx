...
class HitdatalifecycleApiService {
    ...
    CreateHitdatalifecycle = async (payload: HitdatalifecyclePayload) => {
       const statusIds  = payload.statusId;
        ...
        {
            try {
                const response = await this.httpClientWrapper.ALpost('/api/hitrecordlifecycle/createhitrecordlifecycle', payload);
    ...
    getHitdatalifecycle = async () => {
        try {
            const response = await this.httpClientWrapper.ALget('/api/hitdatalifecycle');
            return response;
        } catch (error) {
    ...
    updateHitdatalifecycle = async (id: number, payload: HitdatalifecyclePayload) => {
        ...
        try {
            const response = await this.httpClientWrapper.ALput(`/api/hitdatalifecycle/${id}`, payload);
            const data = response.data;
...
blockHitdatalifecycle = async (id: number) => {
    ...
    try {
        const response = await this.httpClientWrapper.ALput(`/api/hitdatalifecycle/${id}/block` );
        const data = response.data;
        console.log("Response data:", data);
        return data; // You may return the data if needed
    } catch (error) {
...
unblockSearch= async (id: number) => {
    ...
    try {
        const response = await this.httpClientWrapper.ALput(`/api/hitdatalifecycle/{id}/${id}/unblock` );
        const data = response.data;
        console.log("Response data:", data);
        return data; // You may return the data if needed
    } catch (error) {
