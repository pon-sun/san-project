...
class HitcaseApiService {
    ...
    CreateHitcase = async (payload: HitcasePayload) => {
        try {
            const response = await this.httpClientWrapper.ALpost('/api/hitcase/CreateHitcase', payload);
    ...
    CreateHitCaseInsert = async (payload: HitcasePayload) => {
        try {
            const response = await this.httpClientWrapper.ALpost('/api/insert/CreateHitCase', payload);
            const data = response.data;
            return data;
        } catch (error) {
            throw error;
