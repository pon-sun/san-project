...
import { Address, AliasesData, All, Birthdate, Country, Customer, Program, List, CustomerRequest, DetailsData, IdentificationData, NationalityData, PlaceOfBirthData, SearchDTO } from '../../data/services/viewpage/view_payload';
                        ...
                        <Card style={{ padding: '1%', boxShadow: 'rgb(0 0 0 / 28%) 0px 4px 8px', width: '100%' }}>
                            <div className="card-body" >
                                    ...
                                    <Grid container spacing={2} justifyContent="space-between">
                                        {/* <Grid item xs={3}>
                                            {details.slice(0, Math.ceil(details.length / 3)).map((details, index) => (
                                                <p key={index}><b>{details.heading}  :</b>  {details.val}</p>
                                            ))}
                                        </Grid>                                 
                                        <Grid item xs={3}>
                                ...
                                <div style={{ display: 'flex' }}>
                                    <Button variant="contained" style={{ marginRight: '1%' }} onClick={handleBackClick}>
                                        Back
                                    </Button>
                                </div>
                            </div>
