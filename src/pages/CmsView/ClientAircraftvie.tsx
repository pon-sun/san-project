...
import { faUserCircle, faRecordVinyl, faRegistered, faFile, faUser, faFlag, faAddressCard, faSync, faCalendarAlt, faExternalLinkAlt, faPerson, faBalanceScale, faTimes } from '@fortawesome/free-solid-svg-icons';
...
const ClientAircraftview: React.FC = () => {
    ...
    useEffect(() => {
        handleButtonClick(parseInt(cmsId || '0', 10), 4, 'image');
        handleButtonClick(parseInt(cmsId || '0', 10), 4, 'pdf');
                ...
                return (
                    <div>
                        <Grid item xs={12}>
                            <React.Fragment>
                                <Col xs={1}>
                                    <div onClick={() => handleButtonClick(parseInt(cmsId || '0', 10), 4, 'image')}>
                                    </div>
                                </Col>
                                {base64Image && (
...
export default ClientAircraftview;