...
const Shipview: React.FC = () => {
    ...
    const backendColumns = ['RecordType', 'Source Link', 'Regulator', 'RegulatorList', 'Name', 'Aliases Name', 'RegistrationNumber', 'Address', 'Country Details', 'Individual Details', 'Case Details'];
