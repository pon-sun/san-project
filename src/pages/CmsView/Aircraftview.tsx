...
import { faUserCircle, faRecordVinyl, faRegistered, faFile, faUser, faFlag, faVenus, faMars, faAddressCard, faBirthdayCake, faMapMarker, faExternalLinkAlt, faPerson, faBalanceScale, faCertificate, faCalendar, faTimes } from '@fortawesome/free-solid-svg-icons';
...
const Aircraftview: React.FC = () => {
    ...
    const backendColumns = ['RecordType', 'Source Link', 'Regulator', 'RegulatorList', 'Name', 'Aliases Name', 'Gender', 'Date of Birth', 'BirthYearAlone', 'Place of Birth', 'Dead', 'Address', 'Country Details', 'Individual Details', 'Case Details'];
                            ...
                            >
                                <Box m={4}>
                                    <Grid container justifyContent="space-between" alignItems="center">
                                        <Grid item>
                                            <h4 style={{ marginBottom: '1%' }}>AIRCRAFT VIEW</h4>
                                        </Grid>
                                    </Grid>
