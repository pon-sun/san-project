...
const Clientship: React.FC = () => {
    ...
    const getRelativeById = (contactId: string) => {
        if (!relative) return 'Loading...';
        const country = relative.find((c) => String(c.id) === contactId);
        return country ? country.name : 'Not Available';
    };
    ...
    useEffect(() => {
        handleButtonClick(parseInt(cmsId || '0', 10), 3, 'image');
        handleButtonClick(parseInt(cmsId || '0', 10), 3, 'pdf');

    }, []);

    const backendColumns = ['RecordType', 'Source Link', 'Regulator', 'RegulatorList', 'Name', 'Aliases Name', 'RegistrationNumber', 'Address', 'Country Details', 'Individual Details', 'Case Details', 'Photo'];
                                        ...
                                        <Table>
                                            <TableHead>
                                                <TableRow>
                                                    ...
                                                    <TableCell><strong>IdentificationNumber</strong></TableCell>
                                                    <TableCell><strong>IdentificationDetails</strong></TableCell>
                                                </TableRow>
                                            </TableHead>
                                            <TableBody>
                                                {isLoading ? (
                ...
                return (
                    <div>
                        <Grid item xs={12}>
                            <React.Fragment>
                                <Col xs={1}>
                                    <div onClick={() => handleButtonClick(parseInt(cmsId || '0', 10), 3, 'image')}>
