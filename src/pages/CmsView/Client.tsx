...
import { faUserCircle, faRecordVinyl, faRegistered, faFile, faUsers, faMobile, faUser, faFlag, faVenus, faMars, faSkull, faBuilding, faAddressCard, faHandshake, faIdCard, faBirthdayCake, faSync, faCalendarAlt, faGlobe, faMapMarker, faInfoCircle, faUserTie, faIndustry, faChild, faExternalLinkAlt, faBusinessTime, faList, faHome, faRing, faGraduationCap, faPerson, faBalanceScale, faPhone, faMailBulk, faCertificate, faCalendar, faTimes, faUniversity } from '@fortawesome/free-solid-svg-icons';
import Header from '../../layouts/header/header';
import profile from '../../assets/Avatar.png';
import { createDetailsRequest, Regulator, RegulatorListData, AliasesNameRequest, Gender, BirthDataRequest, PlaceofBirthRequest, RecordTypeData, Dead, DateofBirthRequest, RelativePayload, InorgPayload, CustomerRequest, AliasesDTO, AddressDTO, DateOfBirthDTO, DetailsCombineDTO, CreateCountryRegistrationRequest, IdNumberData, CountryHqData, CreateCaseDetailsRequest, createBankDetailsRequests, createCompanyDetailsRequests, createIndPositionsRequests, bank, createIndCaseDetailsRequests, ContactDetailsData, RelativeConfigData } from '../../data/services/Search/search-payload';
...
const Client: React.FC = () => {
    ...
    const backendColumns = ['RecordType', 'Source Link', 'Regulator', 'RegulatorList', 'Name', 'Aliases Name', 'Address', 'Country Details', 'Individual Details', 'Case Details', 'Case Detail', 'Bank Details', 'Photo'];
            ...
            case 'Individual Details':
                return (
                    <div>
                        {countryformData && countryformData.length > 0 ? (
                            <div>
                                {indOrgformData && indOrgformData.indOrgCommonDTO && indOrgformData.indOrgCommonDTO.length > 0 ? (
                                    <Grid item xs={12} sm={12}>
